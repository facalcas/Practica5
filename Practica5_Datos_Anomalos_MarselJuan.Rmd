...
clean_iris<-clean_iris%>%
  mutate(tressigmaPetalLength=regla3sigma(Petal.Length))%>%
  mutate(hampelPetalLength=identi_hampel(Petal.Length))%>%
  mutate(boxplotPetalLength=regla_boxplot(Petal.Length))%>%
  mutate(percentilesPetalLength=regla_percentiles(Petal.Length))
```
...
clean_iris%>%
  summarise(across(c(tressigmaPetalLength,hampelPetalLength,boxplotPetalLength,percentilesPetalLength),sum))

clean_iris%>%
  filter(tressigmaPetalLength==T|hampelPetalLength==T|boxplotPetalLength==T|percentilesPetalLength==T)%>%
